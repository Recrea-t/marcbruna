	...
	return (
		<Container>
			...
			<div className="configurador row row-cols-1 row-cols-sm-2 my-3 g-0">
				<Img className="d-none d-sm-block col-sm-7" fluid={image.childImageSharp.fluid} alt={`${name} de Finstral`} />

				<div className="col col-sm-5 bg-primary p-3 d-flex flex-column mx-auto">
					<div className="m-3">
						<Img fluid={configurator.image.childImageSharp.fluid} alt="Configurador de Finstral" />
					</div>
